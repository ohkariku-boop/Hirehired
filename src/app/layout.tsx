...
export const metadata: Metadata = {
  ...
  description:
    "Mid, senior, and director-level roles from direct career pages, ATS boards, and selected feeds. Apply opens the listing we found. Hirehired does not take the application.",
