      ...
      <main className="mx-auto max-w-3xl px-5 sm:px-8 pt-24 pb-20">
        ...
        <div className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-xl border border-border bg-card p-5">
            <h2 className="text-[15px] font-semibold">For candidates</h2>
          ...
          <div className="rounded-xl border border-border bg-card p-5">
            <h2 className="text-[15px] font-semibold">For employers</h2>
            <p className="mt-2 text-[13px] leading-relaxed text-muted">
        ...
        <div className="mt-12">
          <Link
            href="/jobs/"
            className="inline-flex h-10 items-center rounded-full bg-accent px-5 text-[13px] font-semibold text-background hover:bg-accent-dim transition-colors"
          >
            Browse jobs
          </Link>
        </div>
